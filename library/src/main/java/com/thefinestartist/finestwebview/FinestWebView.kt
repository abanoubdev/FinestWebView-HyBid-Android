...
data class FinestWebView(
    ...
    fun iconDisabledColorRes(@ColorRes colorRes: Int) =
        apply { this.iconDisabledColor = ContextCompat.getColor(context, colorRes) }

    fun iconPressedColor(@ColorInt color: Int) = apply { this.iconPressedColor = color }
    fun iconPressedColorRes(@ColorRes colorRes: Int) =
        apply { this.iconPressedColor = ContextCompat.getColor(context, colorRes) }
    ...
    fun disableIconClose(disableIconClose: Boolean) =
        apply { this.disableIconClose = disableIconClose }
    ...
    fun disableIconForward(disableIconForward: Boolean) =
        apply { this.disableIconForward = disableIconForward }
    ...
    fun showSwipeRefreshLayout(showSwipeRefreshLayout: Boolean) =
        apply { this.showSwipeRefreshLayout = showSwipeRefreshLayout }

    fun swipeRefreshColor(@ColorInt color: Int) = apply { this.swipeRefreshColor = color }
    fun swipeRefreshColorRes(@ColorRes colorRes: Int) =
        apply { this.swipeRefreshColor = ContextCompat.getColor(context, colorRes) }
    ...
    fun dividerColorRes(@ColorRes colorRes: Int) =
        apply { this.dividerColor = ContextCompat.getColor(context, colorRes) }
    ...
    fun titleDefaultRes(@StringRes stringRes: Int) =
        apply { this.titleDefault = context.getString(stringRes) }

    fun updateTitleFromHtml(updateTitleFromHtml: Boolean) =
        apply { this.updateTitleFromHtml = updateTitleFromHtml }
    ...
    fun titleSizeRes(@DimenRes titleSize: Int) =
        apply { this.titleSize = context.resources.getDimension(titleSize) }
    ...
    fun titleColorRes(@ColorRes colorRes: Int) =
        apply { this.titleColor = ContextCompat.getColor(context, colorRes) }
    ...
    fun urlSizeRes(@DimenRes urlSize: Int) =
        apply { this.urlSize = context.resources.getDimension(urlSize) }

    fun urlFont(urlFont: String?) = apply { this.urlFont = urlFont }

    fun urlColor(@ColorInt color: Int) = apply { this.urlColor = color }
    fun urlColorRes(@ColorRes colorRes: Int) =
        apply { this.urlColor = ContextCompat.getColor(context, colorRes) }

    fun menuColor(@ColorInt color: Int) = apply { this.menuColor = color }
    fun menuColorRes(@ColorRes colorRes: Int) =
        apply { this.menuColor = ContextCompat.getColor(context, colorRes) }

    fun menuTextGravity(gravity: Int) = apply { this.menuTextGravity = gravity }

    fun menuTextPaddingLeft(menuTextPaddingLeft: Float) =
        apply { this.menuTextPaddingLeft = menuTextPaddingLeft }

    fun menuTextPaddingLeft(menuTextPaddingLeft: Int) =
        apply { this.menuTextPaddingLeft = menuTextPaddingLeft.toFloat() }

    fun menuTextPaddingLeftRes(@DimenRes menuTextPaddingLeft: Int) =
        apply { this.menuTextPaddingLeft = context.resources.getDimension(menuTextPaddingLeft) }

    fun menuTextPaddingRight(menuTextPaddingRight: Float) =
        apply { this.menuTextPaddingRight = menuTextPaddingRight }

    fun menuTextPaddingRight(menuTextPaddingRight: Int) =
        apply { this.menuTextPaddingRight = menuTextPaddingRight.toFloat() }

    fun menuTextPaddingRightRes(@DimenRes menuTextPaddingRight: Int) =
        apply { this.menuTextPaddingRight = context.resources.getDimension(menuTextPaddingRight) }

    fun menuDropShadowColor(@ColorInt color: Int) = apply { this.menuDropShadowColor = color }
    fun menuDropShadowColorRes(@ColorRes colorRes: Int) =
        apply { this.menuDropShadowColor = ContextCompat.getColor(context, colorRes) }

    fun menuDropShadowSize(menuDropShadowSize: Float) =
        apply { this.menuDropShadowSize = menuDropShadowSize }

    fun menuDropShadowSize(menuDropShadowSize: Int) =
        apply { this.menuDropShadowSize = menuDropShadowSize.toFloat() }

    fun menuDropShadowSizeRes(@DimenRes menuDropShadowSize: Int) =
        apply { this.menuDropShadowSize = context.resources.getDimension(menuDropShadowSize) }
    ...
    fun menuTextSizeRes(@DimenRes menuTextSize: Int) =
        apply { this.menuTextSize = context.resources.getDimension(menuTextSize) }
    ...
    fun menuTextColorRes(@ColorRes colorRes: Int) =
        apply { this.menuTextColor = ContextCompat.getColor(context, colorRes) }

    fun showMenuRefresh(showMenuRefresh: Boolean) = apply { this.showMenuRefresh = showMenuRefresh }

    fun stringResRefresh(@StringRes stringResRefresh: Int) =
        apply { this.stringResRefresh = stringResRefresh }
    ...
    fun showMenuShareVia(showMenuShareVia: Boolean) =
        apply { this.showMenuShareVia = showMenuShareVia }

    fun stringResShareVia(@StringRes stringResShareVia: Int) =
        apply { this.stringResShareVia = stringResShareVia }

    fun showMenuCopyLink(showMenuCopyLink: Boolean) =
        apply { this.showMenuCopyLink = showMenuCopyLink }

    fun stringResCopyLink(@StringRes stringResCopyLink: Int) =
        apply { this.stringResCopyLink = stringResCopyLink }

    fun showMenuOpenWith(showMenuOpenWith: Boolean) =
        apply { this.showMenuOpenWith = showMenuOpenWith }

    fun stringResOpenWith(@StringRes stringResOpenWith: Int) =
        apply { this.stringResOpenWith = stringResOpenWith }
    ...
    fun setCloseAnimations(@AnimRes animationCloseEnter: Int, @AnimRes animationCloseExit: Int) =
        apply {
            this.animationCloseEnter = animationCloseEnter
            this.animationCloseExit = animationCloseExit
        }

    fun backPressToClose(backPressToClose: Boolean) =
        apply { this.backPressToClose = backPressToClose }

    fun stringResCopiedToClipboard(@StringRes stringResCopiedToClipboard: Int) =
        apply { this.stringResCopiedToClipboard = stringResCopiedToClipboard }

    fun webViewSupportZoom(webViewSupportZoom: Boolean) =
        apply { this.webViewSupportZoom = webViewSupportZoom }

    fun webViewMediaPlaybackRequiresUserGesture(webViewMediaPlaybackRequiresUserGesture: Boolean) =
        apply {
            this.webViewMediaPlaybackRequiresUserGesture = webViewMediaPlaybackRequiresUserGesture
        }

    fun webViewBuiltInZoomControls(webViewBuiltInZoomControls: Boolean) =
        apply { this.webViewBuiltInZoomControls = webViewBuiltInZoomControls }

    fun webViewDisplayZoomControls(webViewDisplayZoomControls: Boolean) =
        apply { this.webViewDisplayZoomControls = webViewDisplayZoomControls }

    fun webViewAllowFileAccess(webViewAllowFileAccess: Boolean) =
        apply { this.webViewAllowFileAccess = webViewAllowFileAccess }

    fun webViewAllowContentAccess(webViewAllowContentAccess: Boolean) =
        apply { this.webViewAllowContentAccess = webViewAllowContentAccess }

    fun webViewLoadWithOverviewMode(webViewLoadWithOverviewMode: Boolean) =
        apply { this.webViewLoadWithOverviewMode = webViewLoadWithOverviewMode }

    fun webViewSaveFormData(webViewSaveFormData: Boolean) =
        apply { this.webViewSaveFormData = webViewSaveFormData }

    fun webViewTextZoom(webViewTextZoom: Int) = apply { this.webViewTextZoom = webViewTextZoom }

    fun webViewUseWideViewPort(webViewUseWideViewPort: Boolean) =
        apply { this.webViewUseWideViewPort = webViewUseWideViewPort }

    fun webViewSupportMultipleWindows(webViewSupportMultipleWindows: Boolean) =
        apply { this.webViewSupportMultipleWindows = webViewSupportMultipleWindows }

    fun webViewLayoutAlgorithm(webViewLayoutAlgorithm: LayoutAlgorithm?): FinestWebView =
        apply { this.webViewLayoutAlgorithm = webViewLayoutAlgorithm }

    fun webViewStandardFontFamily(webViewStandardFontFamily: String?) =
        apply { this.webViewStandardFontFamily = webViewStandardFontFamily }

    fun webViewFixedFontFamily(webViewFixedFontFamily: String?) =
        apply { this.webViewFixedFontFamily = webViewFixedFontFamily }

    fun webViewSansSerifFontFamily(webViewSansSerifFontFamily: String?) =
        apply { this.webViewSansSerifFontFamily = webViewSansSerifFontFamily }

    fun webViewSerifFontFamily(webViewSerifFontFamily: String?) =
        apply { this.webViewSerifFontFamily = webViewSerifFontFamily }

    fun webViewCursiveFontFamily(webViewCursiveFontFamily: String?) =
        apply { this.webViewCursiveFontFamily = webViewCursiveFontFamily }

    fun webViewFantasyFontFamily(webViewFantasyFontFamily: String?) =
        apply { this.webViewFantasyFontFamily = webViewFantasyFontFamily }

    fun webViewMinimumFontSize(webViewMinimumFontSize: Int) =
        apply { this.webViewMinimumFontSize = webViewMinimumFontSize }

    fun webViewMinimumLogicalFontSize(webViewMinimumLogicalFontSize: Int) =
        apply { this.webViewMinimumLogicalFontSize = webViewMinimumLogicalFontSize }

    fun webViewDefaultFontSize(webViewDefaultFontSize: Int) =
        apply { this.webViewDefaultFontSize = webViewDefaultFontSize }

    fun webViewDefaultFixedFontSize(webViewDefaultFixedFontSize: Int) =
        apply { this.webViewDefaultFixedFontSize = webViewDefaultFixedFontSize }

    fun webViewLoadsImagesAutomatically(webViewLoadsImagesAutomatically: Boolean) =
        apply { this.webViewLoadsImagesAutomatically = webViewLoadsImagesAutomatically }

    fun webViewBlockNetworkImage(webViewBlockNetworkImage: Boolean) =
        apply { this.webViewBlockNetworkImage = webViewBlockNetworkImage }

    fun webViewBlockNetworkLoads(webViewBlockNetworkLoads: Boolean) =
        apply { this.webViewBlockNetworkLoads = webViewBlockNetworkLoads }

    fun webViewJavaScriptEnabled(webViewJavaScriptEnabled: Boolean) =
        apply { this.webViewJavaScriptEnabled = webViewJavaScriptEnabled }

    fun webViewAllowUniversalAccessFromFileURLs(webViewAllowUniversalAccessFromFileURLs: Boolean) =
        apply {
            this.webViewAllowUniversalAccessFromFileURLs = webViewAllowUniversalAccessFromFileURLs
        }

    fun webViewAllowFileAccessFromFileURLs(webViewAllowFileAccessFromFileURLs: Boolean) =
        apply { this.webViewAllowFileAccessFromFileURLs = webViewAllowFileAccessFromFileURLs }

    fun webViewGeolocationDatabasePath(webViewGeolocationDatabasePath: String?) =
        apply { this.webViewGeolocationDatabasePath = webViewGeolocationDatabasePath }

    fun webViewAppCacheEnabled(webViewAppCacheEnabled: Boolean) =
        apply { this.webViewAppCacheEnabled = webViewAppCacheEnabled }

    fun webViewAppCachePath(webViewAppCachePath: String?) =
        apply { this.webViewAppCachePath = webViewAppCachePath }

    fun webViewDatabaseEnabled(webViewDatabaseEnabled: Boolean) =
        apply { this.webViewDatabaseEnabled = webViewDatabaseEnabled }

    fun webViewDomStorageEnabled(webViewDomStorageEnabled: Boolean) =
        apply { this.webViewDomStorageEnabled = webViewDomStorageEnabled }

    fun webViewGeolocationEnabled(webViewGeolocationEnabled: Boolean) =
        apply { this.webViewGeolocationEnabled = webViewGeolocationEnabled }

    fun webViewJavaScriptCanOpenWindowsAutomatically(webViewJavaScriptCanOpenWindowsAutomatically: Boolean) =
        apply {
            this.webViewJavaScriptCanOpenWindowsAutomatically =
                webViewJavaScriptCanOpenWindowsAutomatically
        }

    fun webViewDefaultTextEncodingName(webViewDefaultTextEncodingName: String?) =
        apply { this.webViewDefaultTextEncodingName = webViewDefaultTextEncodingName }

    fun webViewUserAgentString(webViewUserAgentString: String?) =
        apply { this.webViewUserAgentString = webViewUserAgentString }

    fun webViewNeedInitialFocus(webViewNeedInitialFocus: Boolean) =
        apply { this.webViewNeedInitialFocus = webViewNeedInitialFocus }

    fun webViewCacheMode(webViewCacheMode: Int) = apply { this.webViewCacheMode = webViewCacheMode }

    fun webViewMixedContentMode(webViewMixedContentMode: Int) =
        apply { this.webViewMixedContentMode = webViewMixedContentMode }

    fun webViewOffscreenPreRaster(webViewOffscreenPreRaster: Boolean) =
        apply { this.webViewOffscreenPreRaster = webViewOffscreenPreRaster }
    ...
    fun injectJavaScript(injectJavaScript: String?) =
        apply { this.injectJavaScript = injectJavaScript }
